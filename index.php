...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color: #1A5276">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  <h1 style="color: white">Welcome to</h1>
                  <h1 style="color: white; text-align: center">UNION BANK</h1>
                </div>
              </div>
